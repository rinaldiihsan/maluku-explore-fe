  ...
  return (
    <div className="flex font-poppins items-center justify-between h-screen">
      <div className="flex flex-col gap-y-7">
        ...
        <form onSubmit={signUp} className="flex flex-col gap-y-5">
        ...
        <p className="font-medium text-sm">
          ...
          <Link to="/" className="text-myDarkGreen font-bold mx-2 hover:text-myGreen1 transition-all duration-200 ease-in-out">
            Sign in here
          </Link>
        </p>
      </div>
