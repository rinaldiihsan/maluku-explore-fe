        ...
        <div className="relative cursor-pointer" onClick={toggleDropdown}>
          ...
          {DropdownProfile && (
            <div className="absolute top-12 right-0 mt-2 w-40 bg-white rounded-md shadow-md overflow-hidden">
              ...
              <NavLink to="/not-found" className="block px-4 py-2 text-myDarkGreen hover:bg-myGreen1">
                Order History
              </NavLink>
              <button onClick={logout} className="block w-full px-4 py-2 text-white bg-myDarkGreen hover:bg-myGreen1">
                Logout
              </button>
            </div>
          )}
        </div>
        <div className=" tablet:hidden cursor-pointer" onClick={showToggle}>
