    ...
    >
      <div className="flex flex-col items-center justify-center gap-6">
        <div className="flex flex-col items-center justify-center gap-6 text-white [text-shadow:_0_1px_0_rgb(0_0_0_/_20%)]">
          <p className="text-5xl font-semibold text-center font-clashDisplay">
            Let's start <br />
        ...
        <div className="flex gap-2">
          <Link to="/tour" className="px-7 py-4 font-semibold text-[16px] text-white bg-myDarkGreen rounded-[12px] flex gap-x-2 hover:bg-myGreen2 transition-all duration-200 ease-in-out">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              />
              <path d="M8.56 4V17" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M15.73 6.62V20" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            Lets Tour
          </Link>
          <Link to="/blog" className="px-7 py-4 font-semibold text-[16px] text-white bg-myGreen1 rounded-[12px] hover:bg-myGreen2 transition-all duration-200 ease-in-out">
            See Articles
          </Link>
        </div>
      </div>
